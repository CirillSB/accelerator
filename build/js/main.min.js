...
/* harmony import */ var _modules_show_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/show-menu */ "./js/modules/show-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_show_menu__WEBPACK_IMPORTED_MODULE_3__["showMenu"])();
...
var changeDescriptionVisibility = function changeDescriptionVisibility() {
  ...
  var onlyMobileVisible = document.querySelector('[data-visible-except-mobile]');
  if (window.matchMedia('(max-width: 767px)').matches) {
    onlyMobileVisible.dataset.visibleExceptMobile = 'js-hidden';
  }
  var changeMobileTextVisibility = function changeMobileTextVisibility() {
...
var showMenu = function showMenu() {
  ...
  var menuButtons = document.querySelectorAll('[data-resizing-block-button]');
  var accordionsList = document.querySelectorAll('[data-hiding-block]');
  var controlIcon = document.querySelectorAll('[data-changing-pointer]');
  var collapseMenu = function collapseMenu() {
    accordionsList.forEach(function (el) {
      el.dataset.hidingBlock = 'js-hidden';
    });
    controlIcon.forEach(function (el) {
