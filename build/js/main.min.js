...
var openModalFeedback = function openModalFeedback() {
  modal.classList.add('is-active');
  page.classList.add('scroll-lock-ios');
};
var closeModalFeedback = function closeModalFeedback() {
...
var initModalFeedback = function initModalFeedback() {
  if (window.matchMedia('(min-width: 1024px)').matches) {
    ...
    ['click', 'keydown'].forEach(function (i) {
...
var showMenu = function showMenu() {
  var title = document.querySelectorAll('.main-footer__title');
  var footer = document.querySelector('.main-footer');
  var resizingBlocks = document.querySelectorAll('[data-resizing-block]');
  var changingPointers = document.querySelectorAll('[data-changing-pointer]');
  if (window.matchMedia('(max-width: 767px)').matches) {
    footer.addEventListener('pointerdown', function () {
      for (var i = 0; i < resizingBlocks.length; i++) {
